...
### Экспорт данных
- **FDBuffer экспорт**: Массив частотных данных в CSV формате
- **SIGNATURE_T экспорт**: Массив подписей артефактов в CSV и JSON форматах
- **Флаг экспорта**: `bool m_export_data` - управляет экспортом данных
- **Форматы экспорта**:
  - CSV: для анализа в Excel/табличных редакторах
...
- [ ] Экспорт массива FDBuffer в CSV формат
- [ ] Экспорт массива SIGNATURE_T в CSV и JSON форматы
